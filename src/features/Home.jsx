  ...
  return (
    <>
      ...
      <div className="lol-root">
        ...
        {/* ── HERO ── */}
        <section style={{ padding: '56px 24px 48px', maxWidth: '1100px', margin: '0 auto', textAlign: 'center' }}>
          <motion.div
          ...
          >
            ...
            <div style={{
              ...
              <span style={{ color: '#b07830', fontSize: '11px', fontWeight: '600', letterSpacing: '0.14em', textTransform: 'uppercase' }}>
                ✦ Est. in Bahir Dar, Ethiopia
              </span>
            </div>
            ...
            <h1 style={{
              ...
              LOL <em style={{ fontStyle: 'italic', color: '#c9903a' }}>Café</em>
            </h1>
            ...
            <p style={{
              ...
              Curated flavors, crafted with love. Explore our premium menu of Ethiopian and international selections.
            </p>
            ...
            <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
              <button
                ...
                style={{
                  ...
                  textTransform: 'uppercase',
                  cursor: 'pointer',
                  boxShadow: '0 8px 24px rgba(201,144,58,0.35)',
                  fontFamily: "'DM Sans', sans-serif",
                  transition: 'transform 0.2s, box-shadow 0.2s',
                }}
                onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 14px 34px rgba(201,144,58,0.45)' }}
                onMouseLeave={e => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 8px 24px rgba(201,144,58,0.35)' }}
              >
                Explore Menu
              </button>
              <button
                ...
                onMouseEnter={e => { e.currentTarget.style.color = '#b07830'; e.currentTarget.style.borderColor = '#c9903a' }}
                onMouseLeave={e => { e.currentTarget.style.color = '#9a8878'; e.currentTarget.style.borderColor = '#e8ddd0' }}
              >
                Admin Portal
              </button>
            </div>
          ...
          >
            {[
              { num: `${items.length || '50'}+`, label: 'Menu Items' },
              ...
              <div key={s.label} style={{
                ...
                <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '28px', fontWeight: '600', color: '#c9903a', lineHeight: 1 }}>{s.num}</div>
                <div style={{ fontSize: '10px', color: '#c4b8a8', letterSpacing: '0.1em', textTransform: 'uppercase', marginTop: '5px' }}>{s.label}</div>
              </div>
            ))}
          </motion.div>
        </section>

...
// Fix default icon paths for ESM
...
const BranchMap = forwardRef(({ onMapReady }, ref) => {
  ...
  const center = branches.length ? branches[0].coords : [11.5876434, 37.3878324]
            ...
            <Popup className="max-w-xs bg-white/95 text-slate-900 rounded-xl shadow-xl border border-slate-200">
              <div className="p-3">
                ...
                <div className="mt-3 flex items-center justify-between">
                  <a className="inline-flex items-center gap-2 px-3 py-2 rounded-full bg-rose-600 text-white text-sm font-medium shadow-sm hover:brightness-95 transition" href={b.mapsUrl} target="_blank" rel="noreferrer">Get Directions</a>
